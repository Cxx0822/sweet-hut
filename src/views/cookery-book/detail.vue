  ...
  <div class="cookery-book-detail">
    <el-card class="box-card">
      <el-row :gutter="20">
        <el-col :span="12">
          <h1>基础信息</h1>
          <el-form :model="cookeryBookInfo" label-width="120px">
            ...
            <el-form-item label="材料">
              <div style="margin-bottom: 10px">
                ...
                <el-input-number v-model="materialInfo.number" :min="0" :precision="2"/>
                <el-select v-model="materialInfo.company" filterable allow-create :reserve-keyword="false" placeholder="单位" style="width: 100px;">
              ...
              <el-input v-model="materialInfo.materials" disabled autosize type="textarea" />
            </el-form-item>
            <el-form-item label="注意事项">
              <el-input v-model="cookeryBookInfo.note" autosize type="textarea" />
            </el-form-item>
            <el-form-item>
        ...
        <el-col :span="12">
          ...
          <el-steps direction="vertical" align-center style="height: 500px;">
            <!-- 使用模板字符串拼接 -->
            <el-step
